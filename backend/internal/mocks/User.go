...
func (_m *User) CreateUser(ctx context.Context, user *domain.User) error {
...
func (_m *User) GetUserByID(ctx context.Context, userID uuid.UUID) (*domain.User, error) {
...
func (_m *User) SetLastLoginUser(ctx context.Context, userID uuid.UUID) error {
	ret := _m.Called(ctx, userID)
